...
class ShortDescription extends AbstractGenerator implements GeneratorRequestInterface
{
    public function createPayload(string $text): array
    {
        ...
        return [
            ...
            "prompt" => sprintf("Create HTML short description (only content) of the following product:\n%s", $text),
            "n" => 1,
            "temperature" => 0.5,
            "max_tokens" => 100,
            "frequency_penalty" => 0,
