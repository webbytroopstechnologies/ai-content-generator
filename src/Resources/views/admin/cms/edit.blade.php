                    ...
                    <accordian title="{{ __('admin::app.cms.pages.seo') }}" :active="true">
                        <div slot="body">
                            <div class="control-group">
                                ...
                                <input type="text" id="meta_title" class="control" name="{{$locale}}[meta_title]" value="{{ old($locale)['meta_title'] ?? ($page->translate($locale)['meta_title'] ?? '') }}">
                                @include('ai-content-generator::content.generate-button', 
                                    [
                                       "elementId" => "meta_title",
                                       "entity" => "page",
                                       "generatorType" => "meta_title"
                                    ]
                                )
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <textarea type="text" id="meta_keywords" class="control" name="{{$locale}}[meta_keywords]">{{ old($locale)['meta_keywords'] ?? ($page->translate($locale)['meta_keywords'] ?? '') }}</textarea>
                                @include('ai-content-generator::content.generate-button', 
                                    [
                                       "elementId" => "meta_keywords",
                                       "entity" => "page",
                                       "generatorType" => "meta_keywords"
                                    ]
                                )
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <textarea type="text" id="meta_description" class="control" name="{{$locale}}[meta_description]">{{ old($locale)['meta_description'] ?? ($page->translate($locale)['meta_description'] ?? '') }}</textarea>
                                @include('ai-content-generator::content.generate-button', 
                                    [
                                       "elementId" => "meta_description",
                                       "entity" => "page",
                                       "generatorType" => "meta_description"
                                    ]
                                )
                            </div>
                        </div>
