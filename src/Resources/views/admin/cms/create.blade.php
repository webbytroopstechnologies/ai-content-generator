                    ...
                    <accordian title="{{ __('admin::app.cms.pages.seo') }}" :active="true">
                        <div slot="body">
                            <div class="control-group">
                                ...
                                <input type="text" id="meta_title" class="control" name="meta_title" value="{{ old('meta_title') }}">
                            ...
                            <div class="control-group">
                                ...
                                <textarea type="text" id="meta_keywords" class="control" name="meta_keywords">{{ old('meta_keywords') }}</textarea>
                                @include('ai-content-generator::content.generate-button', 
                                    [
                            ...
                            <div class="control-group">
                                ...
                                <textarea type="text" id="meta_description" class="control" name="meta_description">{{ old('meta_description') }}</textarea>
                                @include('ai-content-generator::content.generate-button', 
                                    [
